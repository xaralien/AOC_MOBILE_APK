...
- IMPORTANT: do **not** upload `mbz.jks` or the `.base64.txt` file.
...
| Secret name        | Value                                              |
|--------------------|----------------------------------------------------|
| KEYSTORE_BASE64    | the full contents of `mbz.jks.base64.txt`    |
| KEYSTORE_PASSWORD  | `mbz2026`                                    |
| KEY_ALIAS          | `mbz`                                         |
| KEY_PASSWORD       | `mbz2026`                                    |
...
```bash
keytool -genkeypair -v -keystore mbz.jks -alias mbz \
  -keyalg RSA -keysize 2048 -validity 10000
# then: base64 -w0 mbz.jks   -> paste into the KEYSTORE_BASE64 secret
```
