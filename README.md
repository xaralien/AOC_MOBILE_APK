...
Android app that wraps **https://mobile.mbzcargo.com/** and bridges native device
...
App name: **AOC**  •  Package: `com.mbzcargo.mobile`
...
1. Install Android Studio, then `File > Open` and select this **MbzApp** folder.
...
keytool -genkey -v -keystore mbz.jks -keyalg RSA -keysize 2048 \
        -validity 10000 -alias mbz
